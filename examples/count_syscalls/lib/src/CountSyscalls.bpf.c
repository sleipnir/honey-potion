...
struct {
  __uint(type, BPF_MAP_TYPE_ARRAY);__uint(max_entries, 335);
...
int helper_var_1221 = ctx_arg->id;


op_result.exception = 0;
int id_1_ = helper_var_1221;
...
Generic *helper_var_1317 = bpf_map_lookup_elem(&Count_Sys_Calls_Invoked, &(id_1_));
int helper_var_1285;
if(!helper_var_1317) {
  ...
  helper_var_1285 = helper_var_1317->value.integer;
}


op_result.exception = 0;
int id_count_2_ = helper_var_1285;
...
int helper_var_1349 = 1;
// Generated at /home/adrianosantos/workspaces/git/me/honey-potion/lib/honey/compiler/translator.ex:1633
int helper_var_1381 = id_count_2_ + helper_var_1349;

// Generated at /home/adrianosantos/workspaces/git/me/honey-potion/lib/honey/compiler/translator.ex:1674
 Generic helper_var_1413 = {0};
 helper_var_1413.type = INTEGER; helper_var_1413.value.integer = helper_var_1381;

helper_var_1413.value.integer = helper_var_1381;
int helper_var_1445 = bpf_map_update_elem(&Count_Sys_Calls_Invoked, &(id_1_), &helper_var_1413, BPF_ANY);


  // =============== end of user code ==============
  // Generated at /home/adrianosantos/workspaces/git/me/honey-potion/lib/honey/codegen/boilerplates.ex:570
return helper_var_1445;
CATCH:
