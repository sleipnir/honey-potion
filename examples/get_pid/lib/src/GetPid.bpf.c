...
int helper_var_1444 = bpf_get_current_pid_tgid();
int helper_var_1476 = 5;
bpf_printk("Current PID: %d; Another number: 5", helper_var_1444, helper_var_1476);
int helper_var_1508 = 0;

  // =============== end of user code ==============
  // Generated at /home/adrianosantos/workspaces/git/me/honey-potion/lib/honey/codegen/boilerplates.ex:570
return helper_var_1508;
CATCH:
