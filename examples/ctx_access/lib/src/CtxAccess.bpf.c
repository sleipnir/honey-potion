...
int helper_var_1351 = ctx_arg->pid;


op_result.exception = 0;
int targetid_1_ = helper_var_1351;
...
int helper_var_1383 = bpf_get_current_pid_tgid();

bpf_printk("PID of callee: %d; PID of target: %d;", helper_var_1383, targetid_1_);
int helper_var_1415 = 0;


  // =============== end of user code ==============
  // Generated at /home/adrianosantos/workspaces/git/me/honey-potion/lib/honey/codegen/boilerplates.ex:570
return helper_var_1415;
CATCH:
