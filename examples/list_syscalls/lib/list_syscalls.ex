defmodule ListSyscalls do
  @moduledoc """
  Documentation for `ListSyscalls`.
  """
  ...
  def main(ctx) do
    ...
    cond do
      id == enter_kill ->
        Honey.BpfHelpers.bpf_printk(["Syscall of type enter_kill"])

      id == enter_mkdir ->
        Honey.BpfHelpers.bpf_printk(["Syscall of type enter_mkdir"])

      id == enter_getrandom ->
        Honey.BpfHelpers.bpf_printk(["Syscall of type enter_getrandom"])
